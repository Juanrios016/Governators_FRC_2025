...
// The robot's subsystems
    ...
    private final ElevatorSubsystemCopy elevatorSystem = new ElevatorSubsystemCopy();
...
// Create some buttons
    ...
    new JoystickButton(xbox, XboxController.Button.kB.value).onTrue(new InstantCommand(elevatorSystem::moveL1, elevatorSystem));
