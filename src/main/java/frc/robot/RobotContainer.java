...
// Create some buttons
    ...
    // new JoystickButton(xbox, XboxController.Button.kA.value).onTrue(new InstantCommand(elevatorSystem::moveToL1, elevatorSystem));
    // new JoystickButton(xbox, XboxController.Button.kY.value).onTrue(new InstantCommand(elevatorSystem::moveToL2, elevatorSystem));
    // new JoystickButton(xbox, XboxController.Button.kX.value).onTrue(new InstantCommand(elevatorSystem::moveToL3, elevatorSystem));
    // new JoystickButton(xbox, XboxController.Button.kB.value).onTrue(new InstantCommand(elevatorSystem::moveDown, elevatorSystem));


    new JoystickButton(xbox, XboxController.Button.kA.value).onTrue(new MoveToLevel(elevatorSystem, 1));
    new JoystickButton(xbox, XboxController.Button.kX.value).onTrue(new MoveToLevel(elevatorSystem, 2));
    new JoystickButton(xbox, XboxController.Button.kY.value).onTrue(new MoveToLevel(elevatorSystem, 3));
    new JoystickButton(xbox, XboxController.Button.kB.value).onTrue(new MoveToLevel(elevatorSystem, 0));

    // new JoystickButton(xbox, XboxController.Button.kLeftBumper.value).onTrue(new MoveToLevel(elevatorSystem, 4));
    // new JoystickButton(xbox, XboxController.Button.kRightBumper.value).onTrue(new MoveToLevel(elevatorSystem, 5));
