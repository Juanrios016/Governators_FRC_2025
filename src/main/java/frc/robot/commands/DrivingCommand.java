...
public class DrivingCommand extends Command {
    ...
    public DrivingCommand(DoubleSupplier right, DoubleSupplier left, DrivingSubsytem subsystem) {
    ...
    @Override
    public void execute() {
        m_drivingSubsytem.drive(m_left.getAsDouble()*-1, m_right.getAsDouble()*-1);
    }
